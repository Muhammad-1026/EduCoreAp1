...
public class SpecialityController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ApiResponse<List<GetSpecialityDto>>> GetAll()
    {
        var response = await _mediator.Send(new GetSpecialities());
    ...
    [HttpGet("{id:Guid}")]
    public async Task<ApiResponse<GetSpecialityDto>> GetById(Guid id)
    {
        var response = await _mediator.Send(new GetSpecialityById(id));
    ...
    [HttpPost]
    public async Task<ApiResponse<CreateSpecialityDto>> Create([FromBody] CreateSpecialityCommand createSpecialityCommand)
    {
        var response = await _mediator.Send(createSpecialityCommand);
